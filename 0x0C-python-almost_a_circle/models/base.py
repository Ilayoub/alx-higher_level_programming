...
""" The program defines a base model class"""
import json
import csv
import turtle
...
class Base:
    ...
    def draw(list_rectangles, list_squares):
        ...
        Args:
            list_rectangles (list): The list of rectangle objects to be drawn
            list_squares (list): The list of square objects to be drawn
        """
        turt = turtle.Turtle()
